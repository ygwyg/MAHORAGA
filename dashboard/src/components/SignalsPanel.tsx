...
import { formatCurrency, getSentimentColor, getQualityColor, getVerdictColor } from '../utils/formatters'
import type { Signal, SignalResearch } from '../types'
...
export function SignalsPanel({ signals, signalResearch }: SignalsPanelProps) {
  return (
    <>
